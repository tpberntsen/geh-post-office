...
{
    internal abstract class CimJsonBaseAttribute : ICimJsonAttributeFromXml
    {
        protected CimJsonBaseAttribute(string name)
        {
            Name = name;
        }

        public string Name { get; }
        public abstract void ParseAttribute(string value);
