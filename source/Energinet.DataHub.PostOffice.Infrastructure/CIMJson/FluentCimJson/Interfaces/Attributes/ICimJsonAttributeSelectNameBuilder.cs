...
{
    /// <summary>
    /// Interface to ensure an attribute builder has a method to set its name
    /// </summary>
    internal interface ICimJsonAttributeElementSelectNameBuilder
    {
        /// <summary>
        ...
        ICimJsonAttributeElementDescriptor WithName(string name);
    }
}
