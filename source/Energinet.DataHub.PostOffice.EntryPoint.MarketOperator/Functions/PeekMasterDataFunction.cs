...
namespace Energinet.DataHub.PostOffice.EntryPoint.MarketOperator.Functions
{
    public sealed class PeekMasterDataFunction
    {
        ...
        public PeekMasterDataFunction(IMediator mediator, IMarketOperatorIdentity operatorIdentity, ExternalBundleIdProvider bundleIdProvider)
        {
            _mediator = mediator;
            ...
            HttpRequestData request)
        {
            ...
            {
                var command = new PeekMasterDataCommand(_operatorIdentity.Gln, _bundleIdProvider.TryGetBundleId(request));
