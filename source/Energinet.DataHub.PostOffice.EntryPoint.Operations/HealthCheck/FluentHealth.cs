...
namespace Energinet.DataHub.PostOffice.EntryPoint.Operations.HealthCheck
{
    internal sealed class FluentHealth : IFluentHealth
    {
        ...
        public FluentHealth(ICosmosDatabaseVerifier cosmosDatabaseVerifier, ISqlDatabaseVerifier sqlDatabaseVerifier, IServiceBusQueueVerifier serviceBusVerifier)
        {
        ...
        private IFluentHealth Verify(string verficationKey, Func<Task<bool>> verifier)
        {
