...
{
    internal sealed class SimulationReceiverMessageBus : IReceiverMessageBus
    {
        private readonly ServiceBusSessionReceiver _receiver;

        public SimulationReceiverMessageBus(ServiceBusSessionReceiver receiver)
        {
            _receiver = receiver;
        }
        ...
        {
            return _receiver.ReceiveMessageAsync(timeout);
        }
